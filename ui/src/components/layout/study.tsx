...
}>({ isImmersive: false, setIsImmersive: () => { } });
  ...
  return (
    <ImmersiveContext.Provider value={{ isImmersive, setIsImmersive }}>
      <div className="h-screen flex flex-col bg-neutral-50 overflow-hidden">
        ...
        <header
          className={cn(
            "bg-white border-b border-neutral-200 flex-shrink-0 z-50 transition-all duration-300",
            isImmersive ? "-translate-y-full h-0 border-none" : "h-14"
          )}
        >

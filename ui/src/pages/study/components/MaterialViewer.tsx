    ...
    if (!url) {
        return (
            <div className="flex flex-col items-center justify-center h-full bg-neutral-50/50 rounded-2xl border-2 border-dashed border-neutral-200 text-neutral-400">
                ...
                <p className="text-sm font-medium">Select a document to begin studying</p>
            </div>
        );
    }
    ...
    return (
        <div
            className={cn(
                ...
                isFullscreen ? "fixed inset-4 z-[100] m-0 rounded-3xl shadow-2xl" : "h-full",
                className
            )}
        >
            {/* Viewer Header */}
                ...
                {type.toLowerCase() === "pdf" ? (
                    ...
                    <div className="p-8 max-w-3xl mx-auto h-full overflow-y-auto bg-white shadow-inner">
                        ...
                        <p className="text-neutral-500 italic text-center mt-20">
                            Interactive text rendering and highlighting for {type} format is coming soon.
                            Please view the source document for full fidelity.
                        </p>
                    </div>
                )}
            </div>

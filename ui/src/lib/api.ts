...
export const socialApi = {
  ...
  unfollow: (userId: string) =>
    request(`/social/unfollow/${userId}`, { method: "DELETE" }),

  followers: (userId: string, offset = 0, limit = 20) =>
    request(`/social/followers/${userId}?offset=${offset}&limit=${limit}`),

  following: (userId: string, offset = 0, limit = 20) =>
    request(`/social/following/${userId}?offset=${offset}&limit=${limit}`),

  followStats: (userId: string) => request(`/social/follow-stats/${userId}`),
};
...
export const postsApi = {
  ...
  feed: (offset = 0, limit = 20) =>
    request(`/posts/feed?offset=${offset}&limit=${limit}`),

  explore: (offset = 0, limit = 20) =>
    request(`/posts/explore?offset=${offset}&limit=${limit}`),

  userPosts: (userId: string, offset = 0, limit = 20) =>
    request(`/posts/user/${userId}?offset=${offset}&limit=${limit}`),
